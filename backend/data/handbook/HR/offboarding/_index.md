...
For system access questions and [laptop wipes](https://internal.gitlab.com/handbook/eta/corporate-it/end-user-services/gitlab-laptop-offboarding/) related to offboarding, send an email to `gitlab-laptop-recovery@gitlab.com`.
...
For any other offboarding questions from active team members please reach out to People Operations via [Compass](https://app.serval.com/new-request) or send an email to `people_operations@gitlab.com` if your access has already been terminated.

**Note:** If a termination date changes, please reach out to People Operations via Compass. The team will update Workday.  The notice is used as supporting documentation of the change and is saved in the team members Workday record.
...
1. **Team Member:** You should review the [Offboarding FAQ](/handbook/people-group/offboarding/faq) handbook page to address any questions you may have. If you have a question that is not on that page, please reach out to the People Operations Team using [Compass](https://app.serval.com/new-request). **Note: You will not see your offboarding issue prior to your departure as this is an issue used to deprovision access and is created once you are done working.**
...
Before giving out any information to the caller, please confirm that you are speaking with an agency employee. If you confirm with your state's Unemployment Commission that there is a fraudulent claim, please report it via [Compass](https://app.serval.com/new-request) to the People Operations team.
