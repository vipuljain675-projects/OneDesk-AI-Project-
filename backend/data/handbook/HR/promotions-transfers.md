...
## This page is currently under review and construction

For the most up to date information, please go to [this Loop page](https://theloop.gitlab.com/site/2730fca4-4f91-431d-9564-b61ae1d58fbe/page/069c99f3-8c95-444a-b74b-151adec9c16c) for information.
...
The Sales Development organization reviews In-Cycle Promotions on a monthly basis, due to the specific [promotion criteria](/handbook/sales/sales-development/#sales-dev-career-path) for each level within the job family structure. Planning, calibration and processing steps are aligned to the details below.
...
- **Jan 12-30**: Managers and team members meet to discuss promotion readiness; if aligned on business need and individual readiness, collaborate to prepare [promotion document](https://docs.google.com/document/d/15Zll03CelNs091CDhntRiX2RweripppfQRf-nj4rSig/edit?tab=t.0) form for manager submission by Jan 30
...
The [promotion document](https://docs.google.com/document/d/15Zll03CelNs091CDhntRiX2RweripppfQRf-nj4rSig/edit?tab=t.0) is required for all in-line promotions. **Promotion documents should not exceed three pages total.**
...
- Once approved, the manager informs the individual and should request the necessary changes by submitting a [request via Compass](https://app.serval.com/new-request). A [Job Change Letter](https://docs.google.com/document/d/12AscsmP3qnTqCC9h6cx1UpIVrnZUfoN6AvfMjf8guyg/editm) will then be created.
...
1. Create a case in [Compass](https://app.serval.com/new-request) for the People Operations team requesting the changes to be made in Workday and provide an effective date.
...
1. In case of `Job Title Specialty` change requests, managers will reach out to the People Operations Team [Compass](https://app.serval.com/new-request) to have a team members `Speciality` updated in Workday.
...
Individual contributors moving into a Management level may or may not need their access to be reviewed, please check-in with your current and new manager to confirm this step. If access should be updated follow the AR process documented [here](/handbook/eta/corporate-it/end-user-services/access-requests/access-requests/).
...
Any other role changes where a Manager feels their team member's role may require an Organization Change Checklist, please reach out to the People Operations team via Compass.
