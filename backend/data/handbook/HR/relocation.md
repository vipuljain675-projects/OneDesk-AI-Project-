...
This process is managed by the People Operations team as the DRI.  For any questions not addressed below, please submit a request via [Compass](/handbook/eta/corporate-it/compass/compass-guide/#how-to-get-help-3-ways-to-reach-compass).
...
Some countries may not be on the US-embargoed list but still require prior GitLab notice and/or approval before traveling to or working from these locations. If you have any questions do not hesitate to contact the People Team via [Compass](https://app.serval.com/new-request).
...
1. Complete the [Relocation Request Form](https://app.serval.com/new-request) to submit the initial request to start the process. Upon completion, the form is sent automatically to People Operations.
...
1. Upload the approval communication from Compass to the team members Workday > Documents folder (approvals & confidential)
...
1. Ping a People Operations Team member for auditing in the private slack channel. The person auditing should make a private comment in the Compass case confirming the audit.
...
1. Once the relocation has been approved, the People Operations Specialist asks the relocating team member in their Compass case:
...
##### Relocating **to or from** India

- The IT Ops team and Accounting team need to be tagged by the People Operations team in the respective [relocation issue](https://gitlab.com/gitlab-com/people-group/people-operations/employment-templates/-/blob/main/.gitlab/issue_templates/relocations.md) when a team member is relocation to or from India. The IT Ops team will then arrange local laptop procurement and confirm whether the team member is due a refresh. The team member's existing laptop should be disposed of at the originating entity prior to relocation.

#### Germany

##### Relocating **to** Germany

Once approvals from all stakeholders (including manager) has been received, the next step where a team member is relocating to Germany would be to get approval from the German Works Council. The People Operations Specialist should complete the following:

- Make a copy of the [Works Council New Hire Checklist - Germany (Relocations)](https://docs.google.com/document/d/12xkKmgTeN0sWKSZfCJ52gJ8sAocpeUpAwYITtJIFI_4/edit?tab=t.0) document and complete all information regarding the relocation.
- Upon info has been completed, the People Operations Specialist should create a Compass child case for Emma Tate requesting Works Council approval. Share a copy of the document you created with Emma Tate (PBP). They will work to get the approvals and update in the Compass case once done.

Once Works Council approval is received, the People Operations Specialist can proceed with:
...
1. Review current [onboarding tasks](https://gitlab.com/gitlab-com/people-group/people-operations/employment-templates/-/blob/main/.gitlab/issue_templates/onboarding_tasks/country_germany.md) for Germany.
