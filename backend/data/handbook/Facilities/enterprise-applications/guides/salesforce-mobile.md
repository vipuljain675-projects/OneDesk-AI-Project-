...
Below you can find instructions on how to login to the Salesforce mobile app via Okta. If you run into any issues attempting to login, please contact IT via the Compass app in Slack (type "Compass" in the top search bar to find it) or it-help@gitlab.com.
...
* Download and Install the following Apps
  ...
  * Salesforce permission enabling access for Android and/or iOS access
    ...
    * If you are not part of the Sales organization and would like to request access, open an [Access Request](https://gitlab.com/gitlab-com/team-member-epics/access-requests/-/issues/new?description_template=Individual_Bulk_Access_Request) and provide business justification and the team will help process the request.
