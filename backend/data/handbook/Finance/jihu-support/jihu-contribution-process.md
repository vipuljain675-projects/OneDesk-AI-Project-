...
The [Engineering Productivity](/handbook/engineering/infrastructure-platforms/developer-experience/) team is the DRI for JiHu Engineering enablement efficiency tooling and metrics.
...
[Iteration training](/handbook/engineering/workflow/development-onboarding/manager/#iteration-training) is available to coach on GitLab's value of iteration. This can be helpful to understand the expectations of GitLab product teams for feature iteration.
...
![Diagrem of the GitLab JiHu MR Process](/images/finance/jihu-support/gitlab-jh-mr-process.jpg)
...
1. The MR goes through our documented review process which includes:
   ...
   1. [GitLab Security Review](/handbook/finance/jihu-support/jihu-security-review-process/#security-review-workflow-for-jihu-contributions), which will be triggered automatically.
...
- [Security review](/handbook/finance/jihu-support/jihu-security-review-process)
- [Database migration review](/handbook/finance/jihu-support/jihu-database-change-process) when applicable
...
- Changes outside of `jh/` directory. Some examples include:
  ...
  - Database migrations related changes should be reviewed following
    [database migration review process](/handbook/finance/jihu-support/jihu-database-change-process).
...
The Application Security team performs a certification of each release that includes JiHu contributions. Please see [this documentation](/handbook/finance/jihu-support/release-certification) for more information about this process.
