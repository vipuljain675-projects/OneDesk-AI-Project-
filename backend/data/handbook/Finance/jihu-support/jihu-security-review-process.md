...
[a number of repositories](/handbook/finance/jihu-support/#projects).
These contributions will be [auto labeled](/handbook/finance/jihu-support/jihu-contribution-process/#jihu-contribution-identification) with the `JiHu contribution` label.
...
the AppSec engineer on [Triage (mentions and issues) Rotation](/handbook/security/product-security/security-platforms-architecture/application-security/runbooks/triage-rotation/). This person should:
...
1. Alternatively, they can ask that someone else review it by linking to the MR in the `#security_help` Slack channel and asking for a reviewer to volunteer
