...
[Release Managers page](/handbook/engineering/releases/release-managers/), under the AppSec Release Certification column.
...
1. Ping the appropriate [release manager](/handbook/engineering/releases/release-managers/) from the delivery team and work with them to remove the MRs from the release
