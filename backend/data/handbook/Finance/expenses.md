...
- If you have any questions regarding a rejected expense due to being out of policy, submit a request under the `Expenses -> General Expenses` tile  [Compass](/handbook/eta/corporate-it/compass/compass-guide/), ensuring that you tag your Manager , and adding any other additional documentation so this can be reviewed.
...
- Unused tickets must be used for future business travel whenever possible. If the Team Member knows they won't be able to use the ticket, please submit a request under the `Expenses -> Travel Related Expenses` page of [Compass](/handbook/eta/corporate-it/compass/compass-guide/).
...
- Coworking space is reimbursable for monthly space and one-off days during business travel. Pre-Approval is needed prior to submitting claims.
...
- If more than 5 days are booked in the month, then Manager and Finance approval (via submitting a request under the `Expenses -> General Expenses` page of [Compass](/handbook/eta/corporate-it/compass/compass-guide/)) is required and needs to be obtained prior to submission of expenses.
...
- As you onboard and start your GitLab journey, new hires will receive a 1,500 USD (or equivalent local currency) stipend to help you towards setting up your home office in your first year. Purchase the items you need using your own funds and submit a claim in Navan for reimbursement. Select the Expense Type: Work From Home – New Hire Stipend.
...
- Any items outside this will fall under an exception to the policy and will require approval prior to purchase via the Compass process - `Expenses -> Home Office Equipment` page of [Compass](/handbook/eta/corporate-it/compass/compass-guide/).
...
- If you have any doubts please connect with the Expense Team by submitting a request under the `Expenses -> Home Office Equipment` page of [Compass](/handbook/eta/corporate-it/compass/compass-guide/). Please note that these purchases are still reviewed by your manager and accounting teams, and any misappropriation of these funds will be flagged.

##### New Hires- 1,500 USD (or equivalent local currency) Guidelines

- Purchase the items you need using your own funds and submit a claim in Navan for reimbursement. Select the Expense Type: Work From Home – New Hire Stipend.
- Please ensure any equipment purchased is compliant with policy. See below for listing.
...
- For further questions regarding expensing of gifts and flowers, please reach out to the AP team by submitting a request under the `Expenses -> General Expenses` page of [Compass](/handbook/eta/corporate-it/compass/compass-guide/).
...
- Team Member laptops can be refreshed after three years of employment. If a Team Member needs a replacement laptop due to damage, they must reach out to IT via an issue before purchasing a new one. See [Laptop handbook page](/handbook/eta/corporate-it/end-user-services/access-requests/) for your reference.
...
- Please refer to the [Merchandise Workflow Guidance](/handbook/marketing/brand-experience/merchandise-handling/#swag-shop) in the Handbook before asking for an exception.
...
- Team Members must submit their expenses through Navan.
- All Individual contractors or C2C, with exception of Nigeria will be reimbursed by iiPay by the 22nd of each month. All expenses must be submitted and approved by the Accounts Payable team (for out of policy expenses) by the 3rd of each month to be included in the current month payment. For contractors with C2C status, be sure to contact the Payroll team via Compass and submit a request under the `Expenses -> General Expenses` page of [Compass](/handbook/eta/corporate-it/compass/compass-guide/) if you need to set up a separate bank for your expense reimbursement.
...
- Please refer to the [Navan End Users Guide](/handbook/business-technology/enterprise-applications/guides/navan-expense-guide/) for instructions on how to use the Navan Expense Tool. Any related questions can be directed to the team via Compass.
