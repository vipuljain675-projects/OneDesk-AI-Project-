...
1. For certain cancellation requests—such as software offboarding—IT will be included in the Zip workflow to determine and complete the required deprovisioning and system offboarding steps. This includes submitting the Remove a System request through the [Tech Stack Update](https://app.serval.com/new-request) process in Compass.
...
- [Trademark](/handbook/marketing/brand-experience/trademark-guidelines/) - information regarding the usage of GitLab's trademark
