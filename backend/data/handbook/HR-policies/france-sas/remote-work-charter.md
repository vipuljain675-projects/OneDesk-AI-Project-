...
Per the stated [Roles & Responsibilities](/handbook/people-policies/france-sas/right-to-disconnect-charter/#roles-and-responsibilities), changes to this page must be approved or merged by a code owner. All contributions are welcome and encouraged.
{{% /panel %}}
...
En cas de besoin d'intervention sur l'équipement par un expert technique, le membre de l'équipe contactera l'équipe informatique via le canal Slack Compass ou en ouvrant un Issue dans le Team Member Enablement Issue Tracker.
...
In the event of a need for intervention on the equipment by a technical expert, the team member will contact the IT team via the Compass Slack app or by opening an issue in the Team Member Enablement Issue Tracker.
